...
-   **My Rasoi Menu System** (Added/Enhanced Nov 3, 2025): Complete restaurant menu management inspired by My Rasoi with:
    ...
    - **Room Service Menu** (Fixed Nov 3, 2025): Mobile-optimized menu at `/menu` for room service ordering with proper category names (fixed "Null" category bug), image display for menu items, and QR code-based room auto-fill
